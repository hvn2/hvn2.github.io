...
**Định lý:** Phép chiếu lên một tập các vector trực chuẩn: Gọi $\\{ \varphi_k\\}$ là một tập các vector trực chuẩn hữu hạn của không gian $H$. Với mọi vector $x \in H$,
$$
Px &=\sum_k{\langle x, \varphi_k \rangle}\\
&= \phi \phi^T x
$$
